        ...
        onFragmentInteractionListener2
{
    ...
    private void define() {
        ...
        /*get fromm intent that which kind of care is this FACTION & set toolbar text*/
        boolean isCareAfter = getIntent().getBooleanExtra("isCareAfter",false);
        if(isCareAfter){
            FACTION = Variables.getCareAfter;
            txtToolbar.setText("مراقبت های بعد");
        }else{

            FACTION = Variables.getCareBefore;
            txtToolbar.setText("مراقبت های قبل");
        }
    ...
    public void onFragmentInteraction(int folderDepth, Object_Data ob) {
        ...
        if(folderDepth == 0){
            /*Open ShowActivity*/
            Intent intent = new Intent(CareActivity.this,ShowActivity.class);
